export declare type DataViewCallback<VehicleDataEventType> = (message: VehicleDataEventType | null, err?: any) => void;
...
export declare type PermissionStates<T extends string> = {
    [key in T]: 'denied' | 'granted';
};
export interface VehicleDataService<VehicleDataEventType extends VehicleDataEvent, VehicleErrorEventType extends VehicleErrorEvent> {
    ...
    viewAll(options: {
        ...
        events: Array<VehicleDataEventType | VehicleErrorEventType>;
    }>;
}
