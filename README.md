...
```typescript
view(options: { addressableName: string; }) => Promise<VehicleDataEventType | VehicleErrorEventType>
```
...
**Returns:** <code>Promise&lt;VehicleDataEventType | VehicleErrorEventType&gt;</code>
...
```typescript
viewAll(options: { addressableName: string; }) => Promise<{ events: Array<VehicleDataEventType | VehicleErrorEventType>; }>
```
...
**Returns:** <code>Promise&lt;{ events: (VehicleDataEventType | VehicleErrorEventType)[]; }&gt;</code>
